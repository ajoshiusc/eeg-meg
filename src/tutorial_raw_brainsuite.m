function tutorial_raw_brainsuite(tutorial_dir)
...
close all;
    %addpath(genpath('/home/ajoshi/Documents/coding_ground/git_rep/BrainSuite_BrainStorm_Integration/src'));
...
AnatDir = fullfile(tutorial_dir, 'sample_raw_bst', 'BSTAnatomy');
RawFile = fullfile(tutorial_dir, 'sample_raw_bst', 'Data', 'subj001_somatosensory_20111109_01_AUX-f.ds');
