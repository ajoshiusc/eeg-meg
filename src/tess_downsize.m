...
%% ===== DOWNSAMPLE REGISTRATION MAPS for FreeSurfer=====
if isfield(TessMat, 'Reg') && isfield(TessMat.Reg, 'Sphere') && isfield(TessMat.Reg.Sphere, 'Vertices') && ~isempty(TessMat.Reg.Sphere.Vertices)
    ...
    if ~isempty(I)
        newSphVert = [];
        newSphVert(J,:) = TessMat.Reg.Sphere.Vertices(I,:);
...
%% ===== DOWNSAMPLE REGISTRATION MAPS for BrainSuite =====
if isfield(TessMat, 'Reg') && isfield(TessMat.Reg, 'Square') && isfield(TessMat.Reg.Square, 'Vertices') && ~isempty(TessMat.Reg.Square.Vertices)
    ...
    if ~isempty(I)
        newSqVert = [];
        newSqVert(J,:) = TessMat.Reg.Square.Vertices(I,:);
